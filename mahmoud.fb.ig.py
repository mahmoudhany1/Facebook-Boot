...
###################################################################
'''
Thise Script Copeyed By Abo Hany Hhhhhhh
'''
###################################################################
#                             COLOR 
...
def baliho():
	...
	Thise Script Maded By Abo Hany 1 Pas Hhhhh
	Thise Script Maded By Abo Hany 1 Pas Hhhhh
	  My Acount https://www.facebook.com/mahmoudhanyhack 
	  """
		...
		print 'ooO--(_)--Ooo'.center(44)
		print ' ' + W
		print ('Abo Hany 1 Pas').center(44)
		print (W + '     [' + G +'facebook informtions gathring '+ W + ']')
		print ' '
####################################################################
#		    Print In terminal
def show_program():
 ...
 ------------------------------------------------------
    ...
    Name       Mahmoud Hany
    CodeName   Mahmoud
    Email      mahmoudhany1020304050607080@gmail.com
...
def menu_reaction_ask():
  try:
	...
	cek = raw_input(R + 'Abo Hany' + W + '/' + R + 'Bot' + W + '/' + R + 'Reaction' + W + ' >> ')
...
def bot():
  try:
	...
	cek = raw_input(R + 'Abo Hany' + W +'/' + R +'Bot ' + W + '>> ')
